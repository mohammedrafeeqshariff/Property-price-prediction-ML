...
const Signup = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const response = await axios.post('https://s51-funny-contents-project-3.onrender.com/SIGNUP',data);
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="form">
        ...
        <input
          ...
          {...register("username", {
            ...
            maxLength: {
              value: 40,
              message: "❗Name is too long, maximum 40x letters",
            },
          })}
        />
        ...
        {errors.country_select && <p>{errors.country_select.message}</p>}
